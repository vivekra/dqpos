...
class osTicket {
    ...
    function alertAdmin($subject, $message, $log=false) {
        ...
        if($email) {
            ...
            Mailer::sendmail($to, $subject, $message, '"'.__('DQServ Alerts').sprintf('" <%s>',$to));
        }
    ...
    static function get_root_path($dir) {
         ...
         * inside the DOCUMENT_ROOT. This is most likely useful if TesNow
         * is run using something like Apache UserDir setting where the
         * DOCUMENT_ROOT of Apache and the installation path of TesNow
