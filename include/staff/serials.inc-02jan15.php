...
<div class="pull-left flush-right" style="padding-top:5px;padding-right:5px;">
    <b><a href="serials.php?a=add" class="Icon newDepartment"><?php echo __('Add New Serial');?></a></b></div>
<div class="clear"></div>
...
$(function() {
    ...
    $(document).on('click', 'a.add-serial', function(e) {
        e.preventDefault();
        $.serialLookup('ajax.php/serials/add', function (serial) {
            window.location.href = 'serials.php?id='+serial.serial_id;
         });
