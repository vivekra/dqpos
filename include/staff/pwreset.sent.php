...
<div id="loginBox">
    <h1 id="logo"><a href="index.php">TesNow <?php echo __('Staff Password Reset'); ?></a></h1>
...
<div id="copyRights">Copyright &copy;<a href='http://www.dqserv.com' target="_blank">DigitalQ Information Services Pvt Ltd</a></div>
</body>
</html>
