...
?>
<div id="loginBox">
    <h1 id="logo"><a href="index.php">TesNow :: <?php echo __('Staff Control Panel');?></a></h1>
...
<a href='http://www.dqserv.com' target="_blank">DigitalQ Information Services Pvt Ltd</a></div>
</body>
</html>
