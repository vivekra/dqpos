...
<head>
    ...
    <title><?php echo ($ost && ($title=$ost->getPageTitle()))?$title:'TesNow :: '.__('Staff Control Panel'); ?></title>
    <!--[if IE]>
    <style type="text/css">
    ...
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor-tesnow.js?c18eac4"></script>
    ...
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.10.3.custom.min.css"
     ...
     <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/font-awesome.min.css?c18eac4">
	  ...
	  <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/import/boot.css">
    <!--[if IE 7]>
...
<div id="container">
    ...
    ?>
    <div id="header">
        <a href="index.php" class="no-pjax pull-left" id="logo">TesNow &mdash; <?php echo __('Customer Support System'); ?></a>
...
<?php } else {
    ...
    <title><?php echo ($ost && ($title=$ost->getPageTitle()))?$title:'TesNow :: '.__('Staff Control Panel'); ?></title><?php
} # endif X_PJAX ?>
    <ul id="nav">
