    ...
    <tr>
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
				...
				<tr>
                    <th nowrap><?php echo __('Vendor Ticket Ref.No'); ?>:</th>
                    <td>
                        <?php echo Format::htmlchars($ticket->getVendorRefNo()); ?>
                    </td>
                </tr>
        ...
        <td width="50%" style="vertical-align:top">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                <tr>
                    <th width="100"><?php echo __('Customer'); ?>:</th>
...
<?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <span id="user-<?php echo $ticket->getOwnerId(); ?>-phone"><?php echo $ticket->getMobileNumber(); ?></span>
                    </td>
                </tr>
				...
				<tr>
                    <th nowrap><?php echo __('Ticket Created Location'); ?>:</th>
                    <td>
                        <?php echo Format::htmlchars($ticket->getCallLoggedIn()); ?>
                    </td>
                </tr>
				
				<tr>
                    <th nowrap><?php echo __('Customer Ticket Ref.No'); ?>:</th>
                    <td>
                        <?php echo Format::htmlchars($ticket->getCustRefNo()); ?>
                    </td>
                </tr>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        <td width="50%">
			...
			<tr>
                    <th width="100"><?php echo __('Invoice Date');?>:</th>
                    <td><?php echo Format::db_date($ticket->getInvoiceDate()); ?></td>
            </tr>
			
			
			<tr>
                    <th width="100"><?php echo __('Invoice No');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getInvoiceNo()); ?></td>
            </tr>
			
			
			
			<tr>
                    <th width="100"><?php echo __('Manufacturer');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getManufacturer()); ?></td>
            </tr>

			<tr>
                    <th width="100"><?php echo __('Model');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getModel()); ?></td>
            </tr>
			
			<tr>
                    <th width="100"><?php echo __('Serial No');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getSerialNo()); ?></td>
            </tr>
        ...
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100"><?php echo __('Billing Type');?>:</th>
                    <td></td>
                </tr>
				<tr>
                    <th width="100"><?php echo __('Billing Name');?>:</th>
                   <td><?php echo Format::htmlchars($ticket->getBillingName()); ?></td>
                </tr>
                <tr>
                    <th nowrap><?php echo __('Billing Address');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getBillingAddress()); ?></td>
                </tr>
                <tr>
                    <th nowrap><?php echo __('Billing Location');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getBillingLocation()); ?></td>
                </tr>
				 <tr>
                    <th nowrap><?php echo __('Nature of Call');?>:</th>
                    <td><?php echo Format::htmlchars($ticket->getNatureCall()); ?></td>
                </tr>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        <td width="50%">
			...
			<tr>
                    <th width="100"><?php echo __('Site Contact Name');?>:</th>
                    <td></td>
                </tr>
                <tr>
                    <th nowrap><?php echo __('Site Contact Email');?>:</th>
                   <td></td>
                </tr>
                <tr>
                    <th nowrap><?php echo __('Site Contact Mobile');?>:</th>
                    <td></td>
                </tr>
			
			<tr>
                    <th nowrap><?php echo __('Site Address');?>:</th>
                    <td></td>
                </tr>
			
			
			<tr>
                    <th nowrap><?php echo __('Site Location');?>:</th>
                    <td></td>
                </tr>
        ...
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
				...
				<tr>
                    <th nowrap><?php echo __('Call Logged Customer Company');?>:</th>
                    <td></td>
                </tr>	
				
				<tr>
                    <th nowrap><?php echo __('Alternate Contact Name');?>:</th>
                    <td></td>
                </tr>
				
				 <tr>
                    <th nowrap><?php echo __('Alternate Email');?>:</th>
                    <td></td>
                </tr>
			
			<tr>
                    <th nowrap><?php echo __('Alternate Customer Mobile');?>:</th>
                   <td></td>
                </tr>
			
			<tr>
                    <th nowrap><?php echo __('Call Logged Customer Location');?>:</th>
                   <td></td>
                </tr>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        ...
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100"><?php echo __('Ticket Type');?>:</th>
