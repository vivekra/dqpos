...
<div class="pull-left" style="width:700px;padding-top:5px;">
 <h2><?php echo __('Ticket Types');?></h2>
 </div>
<div class="pull-right flush-right" style="padding-top:5px;padding-right:5px;">
    <b><a href="helptopics.php?a=add" class="Icon newHelpTopic"><?php echo __('Add New Ticket Type');?></a></b></div>
<div class="clear"></div>
...
<?php foreach (OsticketConfig::allTopicSortModes() as $i=>$m)
    ...
    <thead>
        <tr>
            ...
            <th style="padding-left:4px;vertical-align:middle" width="360"><?php echo __('Ticket Type'); ?></th>
