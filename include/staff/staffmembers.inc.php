...
<div class="pull-right flush-right" style="padding-right:5px;"><b><a href="staff.php?a=add" class="Icon newstaff"><?php echo __('Add New Staff');?></a></b></div>
<div class="clear"></div>
<?php
$res=db_query($query);
