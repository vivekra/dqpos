...
'Search existing customer or add a new customer.'
); ?></p></div>
<div style="margin-bottom:10px;">
    <input type="text" class="search-input" style="width:100%;"
    placeholder="<?php echo __('Search by email, mobile, phone or name'); ?>" id="user-search"
...
<form method="post" class="user" action="<?php echo $info['action'] ?: '#users/lookup/form'; ?>">
    ...
    <?php
        ...
        $form->render(true, __('Create New Customer')); ?>
    </table>
    <hr>
    <p class="full-width">
        <span class="buttons pull-left">
