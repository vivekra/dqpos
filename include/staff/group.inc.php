    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em><strong><?php echo __('Group Information');?></strong>: <?php echo __("Disabled group will limit staffs' access. Admins are exempted.");?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr><td><?php echo __('Can <b>Assign</b> Tickets');?></td>
            <td>
                ...
                &nbsp;&nbsp;<i><?php echo __('Ability to assign tickets to staffs.');?></i>
            </td>
        </tr>
        ...
        <tr><td><?php echo __('Can View Staff Stats');?></td>
            <td>
                ...
                &nbsp;&nbsp;<i><?php echo __('Ability to view stats of other staffs in allowed departments.');?></i>
            </td>
        </tr>
        <tr>
            <th colspan="2">
