 ...
 * a few simple optimizations for the context of TesNow
 *
 *    * The language packs are pre-compiled and distributed (which means
 *      they can be customized).
 *    * The MO file will always be processed by PHP code
 *    * TesNow uses utf-8 output exclusively (for web traffic anyway)
 *
 * These allow us to optimize the MO file for the TesNow project
