...
<div style="width:680px;">
    ...
    '.__('Please note that non-base variables depend on the context of use. Visit TesNow Wiki for up to date documentation.').'
    <br/>
        ...
        <tr>
            ...
            <td valign="top">
                <table width="100%" border="0" cellspacing=1 cellpadding=1>
                    ...
                    <tr><td>%{url}</td><td>'.__('TesNow\'s base url (FQDN)').'</td></tr>
                    <tr><td>%{reset_link}</td>
