...
<head>
    ...
    <meta name="keywords" content="DQSupport, TESNOW, Customer support system, support ticket system">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/tesnow.css?c18eac4" media="screen">
    ...
    <script src="<?php echo ROOT_PATH; ?>js/tesnow.js?c18eac4"></script>
