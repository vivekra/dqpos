...
<div style="display:table-row">
    ...
    <div>
        ...
        <input id="email" placeholder="<?php echo __('e.g. venbha.vs@dqserv.com'); ?>" type="text"
            name="lemail" size="30" value="<?php echo $email; ?>"></label>
    </div>
    <div>
        <label for="ticketno"><?php echo __('Ticket Number'); ?>:
        <input id="ticketno" type="text" name="lticket" placeholder="<?php echo __('e.g. PCID004952'); ?>"
