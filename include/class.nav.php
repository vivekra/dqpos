...
class AdminNav extends StaffNav{
    ...
    function getTabs(){
        ...
        if(!$this->tabs){
			...
			$tabs['product']=array('desc'=>__('Product'),'href'=>'serials.php','title'=>__('Manage Product'));
            if (count($this->getRegisteredApps()))
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'settings':
                    ...
                    break;
                case 'manage':
                    $subnav[]=array('desc'=>__('Ticket Types'),'href'=>'helptopics.php','iconclass'=>'helpTopics');
                ...
                case 'emails':
                    ...
                    break;
                case 'staff':
                    $subnav[]=array('desc'=>__('Staff'),'href'=>'staff.php','iconclass'=>'users');
                    ...
                    break;
				case 'product':
                    $subnav[]=array('desc'=>__('Serials'),'href'=>'serials.php','iconclass'=>'serials');
                    $subnav[]=array('desc'=>__('Customers'),'href'=>'customers.php','iconclass'=>'customers');
                    break;	
                case 'apps':
                    foreach ($this->getRegisteredApps() as $app)
                        $subnav[] = $app;
