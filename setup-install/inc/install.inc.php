...
$info=($_POST && $errors)?Format::htmlchars($_POST):array('prefix'=>'dq_','dbhost'=>'localhost','lang_id'=>'en_US');
?>
<div id="main" class="step2">
    <h1><?php echo __('TesNow Basic Installation'); ?></h1>
        <p><?php echo __('Please fill out the information below to continue your TesNow installation. All fields are required.');?></p>
...
<?php } ?>
    ...
    <div>
        <p><strong><?php echo __('Need Help?');?></strong> <?php echo __('We provide <u>professional installation services</u> and commercial support.');?> <a target="_blank" href="http://dqserv.com/support"><?php echo __('Learn More!');?></a></p>
    </div>
    <div id="overlay"></div>
    <div id="loading">
