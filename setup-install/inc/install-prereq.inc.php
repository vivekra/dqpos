...
?>
    ...
    <div id="main">
            <h2><?php echo __('Thank You for Choosing TesNow!');?></h2>
            <div id="intro">
             <p><?php echo __('We are delighted you have chosen TesNow for your customer support ticketing system!');?></p>
            ...
            <p><?php echo __("Before we begin, we'll check your server configuration to make sure you meet the minimum requirements to install and run TesNow.");?></p>
            <h3><?php echo __('Required');?>: <font color="red"><?php echo $errors['prereq']; ?></font></h3>
            <?php echo __('These items are necessary in order to install and use TesNow.');?>
            <ul class="progress">
            ...
            <?php echo __('You can use TesNow without these, but you may not be able to use all features.');?>
            <ul class="progress">
    ...
    <div id="sidebar">
            ...
            <p>
            <?php echo __('If you are looking for a greater level of support, we provide <u>professional installation services</u> and commercial support with guaranteed response times, and access to the core development team. We can also help customize TesNow or even add new features to the system to meet your unique needs.');?> <a target="_blank" href="http://TesNow.com/support"><?php echo __('Learn More!');?></a>
            </p>
    </div>
