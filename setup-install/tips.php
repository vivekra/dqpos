...
<p><?php echo __('TesNow requires table prefix in order to avoid possible table conflicts in a shared database.');?></p>
</div>
<div id="t10">
...
<p><?php echo __('Name of the database TesNow will use.');?></p>
</div>
<div id="t12">
